---
title: "Glider Deployment Report: amlr30 (January 14, 2026)"
format: 
  pdf: 
    toc: true
    colorlinks: true
...
glider_name <- "amlr30" 
glider_serial <- "1030" 
deployment <-"amlr30-20260114"
deployment_year <- "2026"
deployment_date <- "January 14, 2026"
locale <- "Antarctica" # "CCE", "Antarctica", "Hawaii"

battery_type <- "lithium primary extended" # "lithium primary", "lithium primary extended", "lithium rechargeable", "lithium rechargeable extended"
battery_capacity <- "1050" # "720", "1050", "215", "300"
...
**UPDATE FOR SHADOWGRAPH DEPLOYMENTS** The shadowgraph camera was programmed to take photos every `{r} photo_freq` seconds on dives and climbs, with a XX% red flash brightness. During the deployment, the shadowgraph camera took XX photos and used XX% of the camera storage (XX.X GB). **TODO** - pull from updated netCDF.
      ...
      if (exists(f_var)) {
        ...
        if (length(matching_files) <= 1) {
          ...
          for (m_file in matching_files) {
            full_path <- here::here(base.path, deployment, m_file)
            params <- parse_ma_file(full_path)
